...
/**
 * The address of the item creation function
 */
constexpr const auto ItemCreation = 0x46D96B;

/**
 * The address to exit the item creation function
 */
constexpr const auto ItemCreationExit = 0x46E117;
...
/**
 * Hook the item creation procedure.
 */
void __declspec(naked) itemCreationHook()
{
    __asm
    {
        // EAX = Packet
        ...
        popad
            ...
            // Exit the item creation function
        jmp ItemCreationExit
    }
}
 ...
 */
template<>
void World::hook<HookType::Character>(const toml::table& config)
{
    ...
    ItemCreation::parse("Data/ItemCombinations.toml");
    memory(ItemCreation, 7, (DWORD)itemCreationHook);
}